      ...
      <Modal
        ...
        <Modal.Body
          ...
          <div>
            ...
            <div>
              <h4 tabindex="-1" elementtiming="LCP-target">
                Scenic views
              </h4>
            </div>
          ...
          <div>
            ...
            <div>
              <div className="svg-div">
                ...
                &nbsp; Essentials
                <div>Towels, bed sheets, soap, and toilet paper</div>
              </div>
          ...
          <div>
            ...
            <div>
              <div className="svg-div">
                ...
                &nbsp; Kitchen
                <div>Space where guests can cook their own meals</div>
              </div>
              ...
              <div className="svg-div">
                ...
                &nbsp; Cooking basics
                <div>Pots and pans, oil, salt and pepper</div>
              </div>
              ...
              <div className="svg-div">
                ...
                <div>Bowls, chopsticks, plates, cups, etc.</div>
              </div>
          ...
          <div>
            ...
            <div>
              <div className="svg-div">
                ...
                &nbsp; Waterfront
                <div>Right next to a body of water</div>
              </div>
              ...
              <div className="svg-div">
                ...
                &nbsp; Lake access
                <div>Guests can get to a lake using a path or dock</div>
              </div>
              ...
              <div className="svg-div">
                ...
                &nbsp; Private entrance
                <div>Separate street or building entrance</div>
              </div>
              ...
              <div className="svg-div">
                ...
                &nbsp; Paid resort access
                <div>Guests can use nearby resort facilities</div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              <div className="svg-div">
                ...
                &nbsp; Keypad
                <div>Check yourself into the home with a door code</div>
              </div>
            </div>
          </div>
