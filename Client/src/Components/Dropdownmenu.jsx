...
const Dropdownmenu = () => {
  ...
  return (
    <div>
        ...
        >
           <div class=" dir dir-ltr">
            <svg
              ...
              role="presentation"
              focusable="false"
              style={{display: "block", fill: "none", margin: "2px", height: "20px", width: "20px", stroke: "grey", strokeWidth: "3", overflow: "visible", float:"left"}}
            >
          ...
          <div class="fp36fst dir dir-ltr">
            <svg
              ...
              role="presentation"
              focusable="false"
              style={{display: "block", height: "30px", width: "30px", fill: "grey", float:"right"}}
            >
      ...
      <Dropdown.Menu id="dropdown-menu" align={"lg : end"} show={isShown} style={{backgroundColor: "white", boxShadow: "1px 1px 1px 1px lightgrey"}}>
