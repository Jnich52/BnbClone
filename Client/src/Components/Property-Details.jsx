  ...
  <CardGroup className='card-group'>
    <Card>
      <Card.Header style={{display: 'flex', flexFlow: 'row nowrap', justifyContent:'space-between', verticalAlign:'center'}}>
        ...
        borderRadius:'5rem', padding:'0', margin:'0', }}>
        <svg viewBox="0 0 14 24" role="presentation" aria-hidden="true" focusable="false" 
        style={{height: '1.75rem', width: '1.75rem', display: 'block', fill: 'currentcolor', zIndex:'9999', padding:'0', margin:'0', position:'absolute', right:'-8px', bottom: '0px',}}>
