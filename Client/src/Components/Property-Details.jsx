...
return(
  <CardGroup className='card-group'>
    <Card>
      <Card.Header style={{display: 'flex', flexFlow: 'row nowrap', justifyContent:'space-between', verticalAlign:'center', }}>
        <h3 style={{padding:'0', margin:'0',}}>Treehouse hosted by <br/> Joe Dirt</h3>
        <div style={{display: 'flex', maxHeight: '3.5rem', minWidth: '3.5rem', backgroundImage:`url(${Joe_Dirt})`, backgroundSize:'cover', 
        borderRadius:'5rem', padding:'0', margin:'0', position:'relative',}}>
        <svg viewBox="0 0 14 24" role="presentation" aria-hidden="true" focusable="false" 
        style={{height: '1.75rem', width: '1.75rem', display: 'block', fill: 'currentcolor', padding:'0', margin:'0', position:'absolute', right:'-8px', bottom: '0px',}}>
      ...
      <Card.Body style={{display:'flex',}}>
        <ol style={{display: 'flex', flexFlow: 'row nowrap', listStyleType: 'decimal', textAlign:'left', padding:'0', margin:'0',}}>
          <li style={{display:'flex',}}>5 guests</li> <span>&nbsp; · &nbsp;</span>
          <li style={{display:'flex',}}>2 bedrooms</li> <span>&nbsp; · &nbsp;</span>
          <li style={{display:'flex',}}>3 beds</li> <span>&nbsp; · &nbsp;</span>
